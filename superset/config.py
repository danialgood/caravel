...
SUPERSET_GUNICORN_PID_DIR = os.path.join('~/.superset/', 'gunicorn.pid')
...
MAPBOX_API_KEY = "pk.eyJ1IjoiZGFuaWFsZ29vZCIsImEiOiJjaXY2b2Frc2EwMDA2MnRta3hoOTVqYmxsIn0.1MCOjhvU-a8voOmmfMfxvg"
